...
namespace SqlsugarExtension
{
    ...
    internal sealed class TestCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("5545a0c4-9be2-4d0a-a1d9-3dab53145fb6");
        ...
        private void ShowSqlsugarForm(object sender, EventArgs e)
        {
            ...
            var form = new SqlExtension.UI.MainForm(new SqlExtension.Models.OpenFormDto { 
                ProjectList = list
            });
            form.Show();
        }
